...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ubuntu/ros2_ws_robottest/build/micro_ros_agent/agent/src/xrceagent'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ubuntu/ros2_ws_robottest/build/micro_ros_agent/agent/src/xrceagent'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
